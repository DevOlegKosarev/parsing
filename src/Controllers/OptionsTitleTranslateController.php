...
/**
 * 
 * A controller class that handles the translation of options titles.
 * 
 */
class OptionsTitleTranslateController extends AbstractTranslater
{
    /**
     * The constructor for the options title translate controller class.
     *
    ...
    public function __construct(string $lang)
    {
        ...
        parent::__construct($lang, 'OptionsTitle', $this->translator);
    }
    ...
    public function get(string $key): string
    {
        ...
        // If the translation is not found, return the key as a string
        if ($translation === null) {
            return $key;
        }
